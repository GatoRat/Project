...
TEST_CASE("Util/ConvertW[Number]::ToStr")
{
    ...
    SECTION("ToStr64Padded(uint64_t, wchar_t*, int, wchar_t, wchar_t, bool, wchar_t**)")
    {
        struct
        {
            uint64_t val;
        ...
        data[] =
        {
            ...
            { 184                    ,   0, true ,  0, L'#', { L"-184"                        }},
            { 184                    ,   0, true ,  1, L'#', { L"-184"                        }},
            { 184                    ,   0, true ,  2, L'#', { L"-184"                        }},
            { 184                    ,   0, true ,  3, L'#', { L"-184"                        }},
            { 184                    ,   0, true ,  4, L'#', { L"-184"                        }},
            { 184                    ,   0, true ,  5, L'#', { L"-#184"                       }},
            { 184                    ,   0, true ,  6, L'#', { L"-##184"                      }},
            { 184                    ,   0, true , 99, L'#', { L"-################184"        }},

            { 184                    ,   0, false,  0, L'#', { L"184"                         }},
            { 184                    ,   0, false,  1, L'#', { L"184"                         }},
            { 184                    ,   0, false,  2, L'#', { L"184"                         }},
            { 184                    ,   0, false,  3, L'#', { L"184"                         }},
            { 184                    ,   0, false,  4, L'#', { L"#184"                        }},
            { 184                    ,   0, false,  5, L'#', { L"##184"                       }},
            { 184                    ,   0, false,  6, L'#', { L"###184"                      }},
            { 184                    ,   0, false, 99, L'#', { L"#################184"        }},
