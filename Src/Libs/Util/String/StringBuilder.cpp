...
char* StringBuilder::append(const char* pStr, size_t strLen)
{
...
char* StringBuilder::operator+=(const char* pStr)
{
    if (_pBuffer && pStr)
    {
...
char* StringBuilder::operator+=(const std::string& str)
{
    return append(str.c_str(), str.size());
}

char* StringBuilder::operator+=(char ch)
{
...
char* StringBuilder::operator+=(int64_t val)
{
    if (_pBuffer && _offset < _maxLen)
    {
...
char* StringBuilder::operator+=(int32_t val)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::operator+=(uint64_t val)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::operator+=(uint32_t val)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::append(int64_t val, char groupSeparatorChar)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::append(int32_t val, char groupSeparatorChar)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::append(uint64_t val, char groupSeparatorChar)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::append(uint32_t val, char groupSeparatorChar)
{
    if (_pBuffer && _offset < _maxLen)
    {
        char tmpStr[Convert::MinBufferLen];
...
char* StringBuilder::append(uint64_t val, size_t minWidth, char fillChar)
{
    if (_pBuffer)
    {
...
char* StringBuilder::append(uint32_t val, size_t minWidth, char fillChar)
{
    if (_pBuffer)
    {
        intAppend(val, minWidth, fillChar);
...
char* StringBuilder::appendHex(uint64_t val, bool useUpperCase, unsigned padLen)
{
    if (_pBuffer)
    {
        ...
        else
        {
            ...
            unsigned padOffset = static_cast<unsigned>(sizeof(hexStr)) - padLen;
...
char* StringBuilder::appendHex(const void* pData, size_t dataLen, bool useUpperCase, char separator)
{
...
char* StringBuilder::operator+=(const DateTime& dateTime)
{
    return append(dateTime);
}

char* StringBuilder::append(const DateTime& dateTime, bool useFourDigitYear)
{
    if (_pBuffer && _offset < _maxLen)
    {
        if (useFourDigitYear)
        {
            intAppend(static_cast<uint32_t>(dateTime.year()), 4, ASCII::Zero);
        }
        else
        {
        ...
        intAppend(static_cast<uint32_t>(dateTime.milliSecond()), 3, ASCII::Zero);
    }
    return _pBuffer;
}

void StringBuilder::intAppend(char ch)
{
    if (_offset < _maxLen)
    {
        _pBuffer[_offset++] = ch;
...
void StringBuilder::intAppend(uint64_t val, size_t minWidth, char fillChar)
{
    if (_offset < _maxLen)
    {
        ...
        char* pEnd;
        char* pStr = Convert::ToStr64(val, tmpStr, 0, false, &pEnd);

        size_t width = pEnd - pStr;
        if (width < minWidth)
        {
...
void StringBuilder::intAppend(uint32_t val, size_t minWidth, char fillChar)
{
    if (_offset < _maxLen)
    {
        ...
        char* pEnd;
        char* pStr = Convert::ToStr(val, tmpStr, 0, false, &pEnd);
