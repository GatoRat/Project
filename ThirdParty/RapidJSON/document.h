...
private:
    ...
    enum {
        ...
        kNullFlag = kNullType,
        kTrueFlag = static_cast<int>(kTrueType) | kBoolFlag,
        kFalseFlag = static_cast<int>(kFalseType) | kBoolFlag,
        kNumberIntFlag = static_cast<int>(kNumberType) | kNumberFlag | kIntFlag | kInt64Flag,
        kNumberUintFlag = static_cast<int>(kNumberType) | kNumberFlag | kUintFlag | kUint64Flag | kInt64Flag,
        kNumberInt64Flag = static_cast<int>(kNumberType) | kNumberFlag | kInt64Flag,
        kNumberUint64Flag = static_cast<int>(kNumberType) | kNumberFlag | kUint64Flag,
        kNumberDoubleFlag = static_cast<int>(kNumberType) | kNumberFlag | kDoubleFlag,
        kNumberAnyFlag = static_cast<int>(kNumberType) | kNumberFlag | kIntFlag | kInt64Flag | kUintFlag | kUint64Flag | kDoubleFlag,
        kConstStringFlag = static_cast<int>(kStringType) | kStringFlag,
        kCopyStringFlag = static_cast<int>(kStringType) | kStringFlag | kCopyFlag,
        kShortStringFlag = static_cast<int>(kStringType) | kStringFlag | kCopyFlag | kInlineStrFlag,
